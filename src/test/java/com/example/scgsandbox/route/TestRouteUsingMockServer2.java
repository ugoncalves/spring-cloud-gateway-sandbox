...
public class TestRouteUsingMockServer2 {
    ...
    public TestRouteUsingMockServer2(ClientAndServer clientAndServer) {
        TestRouteUsingMockServer2.clientAndServer = clientAndServer;
    }
